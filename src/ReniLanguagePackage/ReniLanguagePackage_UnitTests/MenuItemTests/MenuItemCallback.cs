...
namespace ReniLanguagePackage_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new ReniLanguagePackagePackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(HoyerWare.ReniLanguagePackage.GuidList.guidReniLanguagePackageCmdSet, (int)HoyerWare.ReniLanguagePackage.PkgCmdIDList.cmdidMyCommand);
