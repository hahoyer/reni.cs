...
static class Extension
{
    ...
    extension(IssueId issueId)
    {
        ...
        internal Result<BinaryTree> GetSyntax(BinaryTree binaryTree)
            => new(binaryTree, issueId.GetIssue(binaryTree.Root, binaryTree.SourcePart));
    }

    extension(IEnumerable<Issue> value)
    {
        public IEnumerable<Issue> GroupIssues => value
