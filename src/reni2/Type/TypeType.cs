...
namespace Reni.Type
{
    ...
    internal sealed class TypeType : TypeBase
    {
        ...
        private class FunctionalFeature : IFunctionalFeature
        {
            ...
            public FunctionalFeature(TypeBase typeBase)
            {
                _typeBase = typeBase;
            }
        ...
        {
            _functionalFeature = new FunctionalFeature(value.AutomaticDereference());
            _value = value;
        }
        ...
        protected override TypeBase GetObjectType() { return _value; }
