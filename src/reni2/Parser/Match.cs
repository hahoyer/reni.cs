...
namespace Reni.Parser
{
    ...
    sealed class Match : ReniObject, IMatch
    {
        [EnableDump]
        ...
        sealed class Sequence : ReniObject, IMatch
        {
            ...
            {
                var result = _data.Match(sourcePosn);
                return result == null ? null : result.Value + _other.Match(sourcePosn + result.Value);
            }
        }

        sealed class FunctionalMatch : ReniObject, IMatch
        {
            [EnableDump]
        ...
        sealed class FindMatch : ReniObject, IMatch
        {
            [EnableDump]
            readonly IMatch _data;
        ...
        sealed class ValueMatch : ReniObject, IMatch
        {
            [EnableDump]
            readonly IMatch _data;
            [EnableDump]
