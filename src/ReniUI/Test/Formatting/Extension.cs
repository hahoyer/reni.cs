...
static class Extension
{
    ...
    {
        string Canonize(char spaceReplacement = '_', bool replaceCarriageReturn = true)
        {
        ...
        public void SimpleFormattingTest
        (
        ...
        )
        {
            ...
            var compiler = CompilerBrowser.FromText(target.Canonize(spaceReplacement, false), parameters);
            ...
            string localCanonize(string target1) => target1.Replace("\r\n", "\n")
            //    .Replace("\n","|||\n")
            ;
