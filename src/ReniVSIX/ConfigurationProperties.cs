...
public sealed class ConfigurationProperties : DialogPage
{
    [Category("List")]
    [Description(
        "If set, list with tagged names or values that are not simple terminals will be splitted.")]
    [UsedImplicitly]
    public bool LineBreaksAtComplexDeclaration { get; set; } = true;
    ...
    [UsedImplicitly]
    public bool AdditionalLineBreaksForMultilineItems { get; set; } = true;
