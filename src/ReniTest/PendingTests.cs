//20:28:18.435 15.09.2022 run 0 of 187 Reni.FeatureTest.Array.ArrayFromList.Run
...
TestRunner.RunTest(new Reni.FeatureTest.Array.ArrayFromList().Run);
...
TestRunner.RunTest(new ReniUI.Test.Formatting.TrainWreck().FunctionWithTrainWreck);
TestRunner.RunTest(new ReniUI.Test.Formatting.TrainWreck().TwoWagons);
TestRunner.RunTest(new ReniUI.Test.Formatting.TrainWreck().TreeWagons);
TestRunner.RunTest(new ReniUI.Test.Formatting.TrainWreck().ComplexHead);
TestRunner.RunTest(new ReniUI.Test.Formatting.TrainWreck().ShortCargo);
TestRunner.RunTest(new ReniUI.Test.Formatting.TrainWreck().MediumCargo);
TestRunner.RunTest(new ReniUI.Test.Formatting.TrainWreck().LongCargo);
TestRunner.RunTest(new ReniUI.Test.Formatting.TrainWreck().TrainWreckInBrackets);
TestRunner.RunTest(new ReniUI.Test.Formatting.TrainWreck().WithOperator);
TestRunner.RunTest(new ReniUI.Test.Formatting.TrainWreck().EnoughIndent);
...
TestRunner.RunTest(new ReniUI.Test.Formatting.Lists().StraightList3);
...
TestRunner.RunTest(new ReniUI.Test.Formatting.Lists().ListOfLists);
...
TestRunner.RunTest(new ReniUI.Test.Formatting.ThenElse().ThenElseWithLineBreak);
TestRunner.RunTest(new ReniUI.Test.Formatting.ThenElse().ThenElseWithLineBreakAndBrackets);
TestRunner.RunTest(new ReniUI.Test.Formatting.ThenElse().ThenWithLineBreak);
